                      ...
                      <input type="hidden" name="id" value="<?php echo $_REQUEST['id']; ?>" >
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="title" id="inputtitle" placeholder="" value="<?php echo $tit; ?>" required>
                            </div>
                            <div class="col-md-3">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="description" id="inputdescription" placeholder="" rows="10" required><?php echo $desc; ?></textarea>
                            </div>
                            <div class="col-md-3">
                            </div>
                        </div>
